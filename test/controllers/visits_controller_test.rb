...
class VisitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visit" do
    assert_difference('Visit.count') do
      post visits_url, params: { visit: { place_id: @visit.place_id, trip_id: @visit.trip_id } }
    end
  ...
  test "should update visit" do
    patch visit_url(@visit), params: { visit: { place_id: @visit.place_id, trip_id: @visit.trip_id } }
